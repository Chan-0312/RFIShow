...
class SettingsPage(QtWidgets.QWidget):
    ...
    def __init__(self):
        ...
        self.line.setGeometry(QtCore.QRect(0, 80 - 50, 20, 121+50))
        self.line.setFrameShape(QtWidgets.QFrame.VLine)
        self.line.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line.setObjectName("line")
        self.line_2 = QtWidgets.QFrame(self)
        self.line_2.setGeometry(QtCore.QRect(780, 80 - 50, 20, 121+50))
        self.line_2.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_2.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_2.setObjectName("line_2")
        self.line_3 = QtWidgets.QFrame(self)
        self.line_3.setGeometry(QtCore.QRect(10, 190 - 50+50, 781, 16))
        ...
        self.label_4.setGeometry(QtCore.QRect(20, 150 - 50+50, 130, 40))
        ...
        self.pb_select_csv.setText("特征文件选择")
        self.le_select_cut = QtWidgets.QLineEdit(self)
        self.le_select_cut.setEnabled(False)
        self.le_select_cut.setGeometry(QtCore.QRect(160, 100 - 50+50, 620, 40))
        self.le_select_cut.setFont(font)
        self.le_select_cut.setObjectName("le_select_cut")
        self.pb_select_cut = QtWidgets.QPushButton(self)
        self.pb_select_cut.setGeometry(QtCore.QRect(20, 100 - 50+50, 130, 40))
        self.pb_select_cut.setFont(font)
        self.pb_select_cut.setObjectName("pb_select_cut")
        self.pb_select_cut.setText("剔除文件选择")
        self.sb_sample_num = QtWidgets.QSpinBox(self)
        self.sb_sample_num.setGeometry(QtCore.QRect(160, 150 - 50+50, 620, 40))
        ...
        self.line_5.setGeometry(QtCore.QRect(0, 220 - 50+50, 20, 111-50))
        self.line_5.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_5.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_5.setObjectName("line_5")
        self.line_6 = QtWidgets.QFrame(self)
        self.line_6.setGeometry(QtCore.QRect(10, 320 - 50 - 50+50, 781, 16))
        self.line_6.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_6.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_6.setObjectName("line_6")
        self.label_3 = QtWidgets.QLabel(self)
        self.label_3.setGeometry(QtCore.QRect(20, 210 - 50+50, 120, 20))
        self.label_3.setFont(font)
        self.label_3.setObjectName("label_3")
        self.label_3.setText("TSNE降维设置")
        self.line_7 = QtWidgets.QFrame(self)
        self.line_7.setGeometry(QtCore.QRect(90 + 40, 210 - 50+50, 701-40, 20))
        self.line_7.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_7.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_7.setObjectName("line_7")
        self.line_8 = QtWidgets.QFrame(self)
        self.line_8.setGeometry(QtCore.QRect(780, 220 - 50+50, 20, 111-50))
        self.line_8.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_8.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_8.setObjectName("line_8")
        self.label_5 = QtWidgets.QLabel(self)
        self.label_5.setGeometry(QtCore.QRect(20, 230 - 50+50, 130, 40))
        self.label_5.setFont(font)
        self.label_5.setAlignment(QtCore.Qt.AlignCenter)
        self.label_5.setText("混乱度")
        self.label_5.setObjectName("label_5")
        self.sb_tsne_perplexity = QtWidgets.QSpinBox(self)
        self.sb_tsne_perplexity.setGeometry(QtCore.QRect(160, 230 - 50+50, 620, 40))
        ...
        self.label_7.setGeometry(QtCore.QRect(20, 340 - 50-50+50, 80, 20))
        self.label_7.setFont(font)
        self.label_7.setObjectName("label_7")
        self.label_7.setText("聚类设置")
        self.label_1 = QtWidgets.QLabel(self)
        self.label_1.setGeometry(QtCore.QRect(20, 260+50, 130, 40))
        self.label_1.setFont(font)
        self.label_1.setAlignment(QtCore.Qt.AlignCenter)
        self.label_1.setText("聚类方法")
        self.label_1.setObjectName("label_1")
        self.label_9 = QtWidgets.QLabel(self)
        self.label_9.setGeometry(QtCore.QRect(410, 360 - 50-50+50, 130, 40))
        self.label_9.setFont(font)
        self.label_9.setAlignment(QtCore.Qt.AlignCenter)
        self.label_9.setObjectName("label_9")
        self.label_9.setText("聚类类别数")
        self.line_9 = QtWidgets.QFrame(self)
        self.line_9.setGeometry(QtCore.QRect(0, 350 - 50-50+50, 20, 61+50))
        self.line_9.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_9.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_9.setObjectName("line_9")
        self.line_10 = QtWidgets.QFrame(self)
        self.line_10.setGeometry(QtCore.QRect(90, 340 - 50-50+50, 701, 20))
        self.line_10.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_10.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_10.setObjectName("line_10")
        self.line_11 = QtWidgets.QFrame(self)
        self.line_11.setGeometry(QtCore.QRect(780, 350 - 50-50+50, 20, 61+50))
        self.line_11.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_11.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_11.setObjectName("line_11")
        self.line_12 = QtWidgets.QFrame(self)
        self.line_12.setGeometry(QtCore.QRect(10, 400 - 50+50, 781, 16))
        self.line_12.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_12.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_12.setObjectName("line_12")
        self.sb_n_clusters = QtWidgets.QSpinBox(self)
        self.sb_n_clusters.setGeometry(QtCore.QRect(520, 360 - 50 - 50+50, 260, 40))
        ...
        self.cbb_cluster_mode.setGeometry(QtCore.QRect(160, 260+50, 260, 40))
        ...
        self.label_6.setGeometry(QtCore.QRect(20, 280+30+50, 130, 40))
        ...
        self.le_cluster_kwargs.setGeometry(QtCore.QRect(160, 280+30+50, 620, 40))
        ...
        self.label_10.setGeometry(QtCore.QRect(20, 340 + 30+50, 120, 20))
        self.label_10.setFont(font)
        self.label_10.setObjectName("label_10")
        self.label_10.setText("显示设置")
        self.line_13 = QtWidgets.QFrame(self)
        self.line_13.setGeometry(QtCore.QRect(0, 350 + 30+50, 20, 61))
        self.line_13.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_13.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_13.setObjectName("line_13")
        self.line_14 = QtWidgets.QFrame(self)
        self.line_14.setGeometry(QtCore.QRect(90, 340 + 30+50, 701, 20))
        self.line_14.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_14.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_14.setObjectName("line_14")
        self.line_15 = QtWidgets.QFrame(self)
        self.line_15.setGeometry(QtCore.QRect(780, 350 + 30+50, 20, 61))
        self.line_15.setFrameShape(QtWidgets.QFrame.VLine)
        self.line_15.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_15.setObjectName("line_15")
        self.line_16 = QtWidgets.QFrame(self)
        self.line_16.setGeometry(QtCore.QRect(10, 400 + 30+50, 781, 16))
        self.line_16.setFrameShape(QtWidgets.QFrame.HLine)
        self.line_16.setFrameShadow(QtWidgets.QFrame.Sunken)
        self.line_16.setObjectName("line_16")
        self.label_11 = QtWidgets.QLabel(self)
        self.label_11.setGeometry(QtCore.QRect(20, 390+50, 130, 40))
        self.label_11.setFont(font)
        self.label_11.setAlignment(QtCore.Qt.AlignCenter)
        self.label_11.setText("局部视野")
        self.label_11.setObjectName("label_11")
        self.sb_edge_size = QtWidgets.QSpinBox(self)
        self.sb_edge_size.setGeometry(QtCore.QRect(160, 390+50, 260, 40))
        ...
        self.pb_confirm.setGeometry(QtCore.QRect(10, 420 + 30+50, 780, 70))
...
class RfiClusterPage(QtWidgets.QWidget):
    ...
    def __init__(self, Stack):
        ...
        if os.path.exists(args["project_path"]+args["temp_data"]+"rfi_c_classx.pkl"):
